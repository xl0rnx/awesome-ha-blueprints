...
<Input
  ...
  description='Integrate with [Adaptive Lighting] (https://github.com/basnijholt/adaptive-lighting) custom integration to provide flicker-free powering on experience. Light will be powered with proper parameters, providing instantaneous settings for brightness and color temperature. [Markdown](https://daringfireball.net/projects/markdown/syntax)'
  selector='boolean'
/>
<Input
